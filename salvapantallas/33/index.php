<html>
    <head>
    		<style>
    			...
    			body{overflow:hidden;filter:invert(100%);padding:0px;margin:0px;}
    		</style>
    </head>
    <body>
        <canvas id="lienzo" width=1920px height=1080px></canvas>
        <script>
            ...
            var numerocirculos = Math.round(Math.random()*50);
            var anchuracirculo = Math.round(Math.random()*20);
            var alpha = 0.5;
